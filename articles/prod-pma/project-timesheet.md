...
description: Artikel ini memberikan maklumat mengenai aplikasi mudah alih Microsoft Dynamics 365 Project Timesheet. Aplikasi mudah alih Lembaran masa Projek membolehkan pengguna untuk menyerahkan dan meluluskan lembaran masa untuk projek pada peranti mudah alih mereka.
author: abruer
ms.date: 06/29/2022
ms.topic: article
ms.prod: ''
...
Aplikasi mudah alih Microsoft Dynamics 365 Project Timesheet membolehkan pengguna menyerahkan dan meluluskan lembaran masa untuk projek pada peranti mudah alih mereka (iPhone or Android). Aplikasi mudah alih ini menampilkan fungsi lembaran masa yang terletak dalam bahagian Pengurusan projek dan perakaunan Dynamics 365 Finance. Membantu kami meningkatkan produktiviti dan kecekapan pengguna, dan juga mendayakan entri dan kelulusan lembaran masa projek yang tepat pada masanya.
...
**Isu:** Semasa daftar masuk ke aplikasi Mudah Alih Lembaran Masa Projek, pengguna menerima mesej ralat yang menyatakan bahawa mereka "tidak boleh mengakses aplikasi '2bc50526-cdc3-4e36-a970-c284c34cbd6e' dalam penyewa tersebut."

**Isu:** Semasa daftar masuk ke aplikasi Mudah Alih Lembaran Masa Projek, pengguna menerima ralat yang menyerupai salah satu contoh berikut:

- "AADSTS50020: Akaun pengguna '[nama pengguna]' daripada penyedia identiti 'https://sts.windows.net/[id aplikasi]' tidak wujud dalam penyewa '[id penyewa]' dan tidak boleh mengakses aplikasi '[id aplikasi]' dalam penyewa tersebut."
- "Pengesahan gagal dengan "Akaun pengguna yang dipilih tidak wujud dalam penyewa '[id penyewa]' dan tidak dapat mengakses aplikasi '[id aplikasi]' dalam penyewa tersebut."

**Penjelasan:** Isu ini berlaku disebabkan oleh perubahan yang telah dibuat kepada Azure Active Directory (Azure AD) pada Mei 2022 dan yang berkaitan dengan pengguna luar. Oleh sebab perubahan ini tidak dibuat pada aplikasi kewangan dan operasi, perubahan ini boleh mempengaruhi pelanggan pada sebarang versi platform atau aplikasi.

**Pembetulan:** Semua pengguna luar mesti dijemput ke penyewa melalui Azure AD. Untuk mendapatkan maklumat lanjut, lihat [Jemput pengguna dengan Azure Active Directory Kerjasama B2B](/power-platform/admin/invite-users-azure-active-directory-b2b-collaboration).
...
Pilih pelanggan yang berkaitan dengan projek untuk lembaran masa. Untuk keluaran awal pada Android, entri oleh pelanggan tidak disokong, kerana anda mesti memilih projek itu dahulu. Jika anda memilih projek itu dahulu, medan **Pelanggan** diisi secara automatik.
