...
| Harga | Tab **Umum** dan halaman **Cipta Pantas** | Sediakan kadar kos untuk peranan, syarikat penyumberan dan kombinasi unit penyumberan. Sebagai contoh, kos pemaju dari Fabrikam India adalah INR 1000 atau kos pemaju dari Fabrikam USA adalah USD 150. | Harganya adalah kadar kos lalai pada setiap unit kos bagi anggaran masuk atau baris sebenar untuk kelas transaksi **Masa**. |
...
Menggunakan contoh untuk penetapan harga pemindahan, maklumat boleh ditukar kepada:
