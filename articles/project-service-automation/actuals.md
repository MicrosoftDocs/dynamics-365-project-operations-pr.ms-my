...
## <a name="using-journals-to-record-costs"></a>Menggunakan jurnal untuk merekodkan kos

Dalam PSA, jurnal membenarkan anda merekodkan kos atau pendapatan dalam bahan, yuran, masa, perbelanjaan atau kelas-kelas transaksi cukai. Jurnal mempunyai pengepala, baris dan tindakan **Sahkan**. Berikut ialah beberapa senario di mana anda mungkin menggunakan jurnal:
